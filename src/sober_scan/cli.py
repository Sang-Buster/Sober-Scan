...
app = typer.Typer(
    name="sober-scan",
    help="A tool that detects alcohol intoxication from facial images.",
...
def main(
    ...
    """Sober-Scan: Detect alcohol intoxication from facial images.
...
# Add commands
app.command(name="detect")(detect_image_command)
